  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8">
      <div className="max-w-7xl mx-auto px-4">
        <h1 className="text-4xl font-bold text-gray-800 mb-8">Search Hotels</h1>
        ...
        {!loading && hotels.length === 0 && !message && (
          <div className="mt-16 text-center text-gray-500">
            <p className="text-lg">Enter your travel details to search for hotels</p>
            <p className="text-sm mt-2">Example: NYC, PAR, LON</p>
          </div>
        )}
      </div>
    </div>
